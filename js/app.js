...
const translations = {
  en: {
    ...
    hero_subhead: "mcecare brings professional home nursing, certified physiotherapy, home lab tests, doctor consultations, and caregiver services directly to your door in Jeddah. Book your home visit today.",
    ...
    about_mission_desc: "mcecare exists to bring professional, high-quality, and reliable medical services directly to Saudi families in Jeddah. We specialize in post-surgery rehabilitation, chronic pain relief, elderly support, and home doctor visits, removing the physical burden of clinic travel.",
    ...
    contact_safety_desc: "At mcecare, patient safety is our highest priority. We follow strict clinical guidelines for home medical care.",
  ...
  ar: {
    ...
    contact_safety_desc: "في mcecare، سلامة المرضى هي أولويتنا القصوى. نتبع إرشادات سريرية صارمة لتقديم الرعاية الطبية المنزلية بأمان.",
