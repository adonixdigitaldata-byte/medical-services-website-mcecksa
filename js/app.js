...
const translations = {
  en: {
    ...
    footer_address: "506, 5th Floor, Advanced Business Center, Khaled Ibn Al Walid, Jeddah, KSA",
  ...
  ar: {
    ...
    footer_address: "٥٠٦، الطابق الخامس، مركز الأعمال المتقدم، شارع خالد بن الوليد، جدة، المملكة العربية السعودية",
