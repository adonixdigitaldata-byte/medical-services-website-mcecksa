...
const translations = {
  en: {
    ...
    footer_address: "Building 6778, King Fahad Branch Rd, Ash Sharafiyah Dist., Secondary No. 3327, Postal Code 22316 (Short Address: AJBS6787), Jeddah, Kingdom of Saudi Arabia",
  ...
  ar: {
    ...
    footer_address: "مبنى 6778، طريق الملك فهد فرعي، حي الشرفية، الرقم الإضافي 3327، الرمز البريدي 22316 (العنوان المختصر: AJBS6787)، جدة، المملكة العربية السعودية",
