...
const translations = {
  en: {
    ...
    hero_subhead: "mceccare brings professional home nursing, certified physiotherapy, home lab tests, doctor consultations, and caregiver services directly to your door in Jeddah. Book your home visit today.",
    ...
    trust_1: "All providers are fully licensed and background checked",
    ...
    trust_5: "Strict medical safety protocols adhered to during visits",
    ...
    service_3_desc: "Schedule home visits with general physicians for diagnostic checks, prescription renewals, and patient monitoring, avoiding clinic travel strain.",
    ...
    about_mission_desc: "mceccare exists to bring professional, high-quality, and reliable medical services directly to Saudi families in Jeddah. We specialize in post-surgery rehabilitation, chronic pain relief, elderly support, and home doctor visits, removing the physical burden of clinic travel.",
    ...
    service_3_details: "Have an experienced general physician visit your home for diagnostic checkups, prescription renewals, chronic condition monitoring, and family checkups without the stress of clinic commutes.",
    ...
    contact_safety_desc: "At mceccare, patient safety is our highest priority. We follow strict clinical guidelines for home medical care.",
    ...
    contact_hours_desc: "Everyday, 8:00 AM - 10:00 PM",
    ...
    footer_blurb: "Providing Saudi families with certified and compassionate home healthcare services directly at their doorstep. Your safety, choice, and recovery are our primary goals.",
    footer_title_services: "Our Services",
    footer_title_company: "Company",
    footer_title_contact: "Contact Us",
    footer_copyright: "Copyright © 2026 mceccare. All rights reserved. Serving Jeddah.",
  ...
  ar: {
    ...
    trust_1: "جميع مقدمي الخدمة مرخصون ومفحوصو السيرة والخبرة",
    ...
    trust_5: "نطبق بروتوكولات سلامة طبية صارمة خلال الزيارات",
    ...
    contact_safety_desc: "في mceccare، سلامة المرضى هي أولويتنا القصوى. نتبع إرشادات سريرية صارمة لتقديم الرعاية الطبية المنزلية بأمان.",
    ...
    contact_hours_desc: "يومياً، ٨:٠٠ صباحاً - ١٠:٠٠ مساءً",
    ...
    footer_blurb: "تقديم خدمات رعاية صحية منزلية معتمدة ورحيمة للعائلات السعودية مباشرة عند عتبة بابهم. إن سلامتك واختيارك وتماثلك للشفاء هي أهدافنا الأساسية.",
